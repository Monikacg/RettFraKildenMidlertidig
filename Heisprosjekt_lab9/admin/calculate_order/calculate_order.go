...
func amIClosestToNewOrder(orders [][]int, properties []int, aliveLifts []int, ID int) (int, bool) {
	...
	fmt.Println("CO: floorsWithOutsideOrders: ", floorsWithOutsideOrders)
	...
	fmt.Println("CO: aliveIdleLifts when function starts: ", aliveIdleLifts)
	...
	fmt.Println("CO: floorsWithOutsideOrders, aliveIdleLifts after insideButton test: ", floorsWithOutsideOrders, aliveIdleLifts)
